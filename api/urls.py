...
from . import account_admin_views, dashboard_views, payment_views, pricing_views, public_matching_views, quote_views, views, workflow_views
...
from jobs.views import (
    ...
    ManagedJobConfirmCompletionView,
    ManagedJobDeliverView,
...
urlpatterns = [
    ...
    path("pricing/quote-financials/preview/", pricing_views.QuoteFinancialPreviewView.as_view(), name="quote-financial-preview"),
    path("pricing/quotes/<int:quote_id>/financials/", pricing_views.QuoteFinancialDetailView.as_view(), name="quote-financial-detail"),
    ...
    path("calculator/buyer-quotes/", workflow_views.BuyerQuotesListView.as_view(), name="calculator-buyer-quotes"),
    ...
    path("payments/<int:pk>/", payment_views.PaymentDetailView.as_view(), name="payment-detail"),
    ...
    # Canonical job workflow (printy_workflow port) - local-first demo, synced to API
    ...
    path("managed-jobs/<int:pk>/delivery/mark-delivered/", ManagedJobDeliverView.as_view(), name="managed-job-mark-delivered"),
    path("managed-jobs/<int:pk>/delivery/confirm/", ManagedJobConfirmCompletionView.as_view(), name="managed-job-confirm-completion"),
    ...
    path("public/managed-jobs/track/<str:token>/", PublicManagedJobTrackingView.as_view(), name="public-managed-job-track"),
    path("managed-jobs/public/<str:token>/", PublicManagedJobTrackingView.as_view(), name="managed-job-public-track"),
    ...
    # Client calculator adapter (port of printy-prototype backend_patch)
    path("client-calculator/", include("client_calculator.urls")),
]
