...
6. Request/response threading is modeled in `CalculatorDraft`, `QuoteRequest`, `Quote`, and `QuoteRequestMessage`.
...
Safest path:
- extend `CalculatorDraft`, `QuoteRequest`, `Quote`, `QuoteRequestMessage`
