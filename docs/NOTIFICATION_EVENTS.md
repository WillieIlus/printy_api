...
| **quote_sent** | Customer | Shop sends quote | quote_request | qr.id |
| **quote_revised** | Customer | Shop revises quote | quote | sq.id |
| **quote_accepted** | Shop owner | Customer accepts quote | quote | sq.id |
