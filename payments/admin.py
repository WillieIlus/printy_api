...
@admin.register(PaymentPhoneConsent)
class PaymentPhoneConsentAdmin(admin.ModelAdmin):
    list_display = ["id", "user", "payment", "source", "phone_number", "created_at"]
    list_filter = ["source", "created_at"]
    search_fields = ["user__email", "phone_number", "payment__account_reference"]
    readonly_fields = [
        "user",
        "payment",
        "stk_request",
