    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                models.F("shop"),
                models.F("slug"),
                models.F("charge_unit"),
                models.F("billing_basis"),
                models.F("side_mode"),
                models.functions.Coalesce("thickness_microns", models.Value(-1)),
                models.F("is_single_sided_only"),
                models.functions.Coalesce("min_qty", models.Value(-1)),
                name="unique_finishing_rate_identity",
            ),
        ]
    def __str__(self):
