...
from quotes.draft_files import (
    ...
    build_calculator_draft_file_payload,
    build_calculator_draft_group_payload,
)
...
def render_calculator_draft_pdf(draft: QuoteRequest) -> bytes:
    try:
        from reportlab.lib.pagesizes import A4
        from reportlab.lib.units import mm
        from reportlab.platypus import Paragraph, SimpleDocTemplate, Spacer
    except ImportError:
        group = build_calculator_draft_group_payload(draft)
        lines = [
            "Printy Quote Draft",
...
def render_calculator_draft_file_pdf(draft_file) -> bytes:
    try:
        from reportlab.lib.pagesizes import A4
        from reportlab.lib.units import mm
        from reportlab.platypus import Paragraph, SimpleDocTemplate, Spacer
    except ImportError:
        payload = build_calculator_draft_file_payload(draft_file)
...
def render_dashboard_quote_file_pdf(draft_file) -> bytes:
    try:
        from reportlab.lib.pagesizes import A4
        from reportlab.lib.units import mm
        from reportlab.platypus import Paragraph, SimpleDocTemplate, Spacer
